...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2 sm:py-2">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link href="/" className="flex items-center">
            <Image
              src="/letras-velmor.png"
              alt="Logo Oficial VELMOR - Marca de accesorios de cuero"
              width={160}
              height={40}
              className="w-auto"
              style={{
                height: "48px",
                filter:
                  "brightness(0) saturate(100%) invert(7%) sepia(91%) saturate(5437%) hue-rotate(237deg) brightness(91%) contrast(105%)",
              }}
              priority
            />
          </Link>
